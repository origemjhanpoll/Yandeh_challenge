...
// in yandeh_challenge/test/app/dependencies/injection_test.dart.
...
class MockRemoteDataSource extends _i1.Mock implements _i7.RemoteDataSource {
  ...
  @override
  _i3.Future<Map<String, dynamic>> getSections({
...
class MockISectionsRepository extends _i1.Mock
    implements _i8.ISectionsRepository {
  MockISectionsRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i9.Section>> getSections({
    bool? originalSections,
    String? argument,
  }) =>
      (super.noSuchMethod(
        ...
        returnValue: _i3.Future<List<_i9.Section>>.value(<_i9.Section>[]),
